			...
			<div id="home" class="realative max-w-4xl flex h-auto flex-wrap mx-auto py-12 lg:my-0">
				...
				<div class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white dark:bg-gray-900 opacity-75 mx-6 lg:mx-0">
					...
					<div class="p-4 md:p-11 text-center lg:text-left">
						...
						<div class="pt-5 pb-8">
							<a class="cursor-pointer bg-blue-600 font-bold hover:bg-blue-900 px-4 py-2 rounded-full text-white transition-all w-2/3 text-sm text-center" target="_blank" href="https://drive.google.com/file/d/1CCMYV9ML4uSRCIAItwyogSeOZiC5qUd5/view?usp=sharing">
								Download CV
							</a> 
						</div>
